    ...
    >
      <section className=" py-16 max-[650px]:py-[30px] flex flex-col gap-14 max-[650px]:gap-6 ">
        <div className=" flex flex-col items-center gap-[20px] max-[650px]:gap-[16px]">
          <h1
            className=" font-semibold text-[36px] leading-[44px] tracking-[-2px] font-inter text-[#101828] 
           max-[650px]:text-[28px] max-[650px]:leading-normal max-[650px]:tracking-normal"
          >
            Frequently asked questions
          </h1>
          <p className=" text-[#475467] text-[18px] leading-[20px] font-inter max-[650px]:text-[14px]">
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="">
              ...
              >
                ...
                >
                  {openIndex === index ? (
                    <CiCircleMinus className="text-2xl text-[#98A2B3] font-semibold" />
                  ) : (
                    <CiCirclePlus className="text-2xl text-[#98A2B3] font-semibold" />
                  )}
                </span>
              </button>
              <div
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center max-[650px]:p-6">
