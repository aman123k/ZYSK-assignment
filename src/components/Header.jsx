...
function Header() {
  ...
  min-[2000px]:ml-[50%] min-[2000px]:translate-x-[-50%] max-[650px]:gap-[40px]"
    >
      <div className=" flex justify-between items-center py-4 border-b border-[#EAECF0]">
        <div className=" flex gap-[40px] items-center">
          <img src={logo} alt="" />
          <div
            className={` max-[850px]:fixed max-[850px]:bg-[#ffff] max-[850px]:w-[350px] max-[650px]:w-[250px] duration-700 ease-in-out
                 max-[850px]:top-0 max-[850px]:h-[100dvh] max-[850px]:left-0 max-[850px]:z-10 max-[850px]:drop-shadow-xl
                ${
          ...
          >
            ...
            max-[850px]:border-t max-[850px]:border-[#EAECF0] max-[850px]:py-6 max-[650px]:gap-3"
            >
              <li
                className=" leading-[24px] text-[#475467] font-semibold  cursor-pointer max-[850px]:w-full max-[850px]:px-10 max-[850px]:py-3 
                max-[850px]:hover:bg-gray-100 max-[850px]:rounded-lg  max-[650px]:px-5 "
              >
                Home
              </li>
              <li
                className=" leading-[24px] text-[#475467] font-semibold  cursor-pointer max-[850px]:w-full max-[850px]:px-10 max-[850px]:py-3 
                max-[850px]:hover:bg-gray-100 max-[850px]:rounded-lg  flex items-center gap-3 max-[650px]:px-5 "
              >
                <span>Products</span>
                <FaAngleDown size={18} color="#475467" />
              </li>
              <li
                className=" leading-[24px] text-[#475467] font-semibold  cursor-pointer max-[850px]:w-full max-[850px]:px-10 max-[850px]:py-3 
                max-[850px]:hover:bg-gray-100 max-[850px]:rounded-lg  flex items-center gap-3 max-[650px]:px-5 "
        ...
        <div>
          ...
          />
          <IoMenu
            className=" hidden max-[850px]:block text-3xl cursor-pointer"
            color="#344054"
