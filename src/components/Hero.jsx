  ...
  min-[2000px]:ml-[50%] min-[2000px]:translate-x-[-50%] max-[650px]:gap-[40px]"
    >
      <section className=" flex flex-col gap-28 overflow-hidden max-[950px]:gap-12">
        ...
        <div className=" flex items-center flex-col gap-[16px] text-center pt-24 max-[850px]:pt-16 max-[650px]:pt-14">
          ...
          <h1
           ...
           max-[850px]:leading-normal max-[850px]:tracking-normal max-[650px]:text-[34px]"
          >
            Beautiful analytics to grow smarter
          </h1>
          <p className=" text-[#475467] text-[20px] text-center max-w-[750px] py-[10px] max-[650px]:py-0 max-[650px]:text-[18px]">
          ...
          <div className=" flex items-center gap-[20px] mt-4 max-[650px]:flex-col-reverse max-[650px]:w-full">
            <button
              className="max-[650px]:w-full justify-center border border-[#D0D5DD] flex items-center gap-3 py-2 px-3.5 rounded-full text-[#344054] text-[16px] font-semibold
        ...
        max-[850px]:max-h-max max-[850px]:rounded-3xl"
        >
      ...
      <section className=" flex items-center flex-col gap-[32px] py-20 font-inter max-[1050px]:py-14 max-[650px]:py-10">
        <h4 className=" text-[#475467] font-[500] text-center leading-[24px]">
          Join 4,000+ companies already growing
        </h4>
        <div
          className=" grid grid-cols-6 items-center gap-14 max-[1050px]:gap-10 max-[850px]:grid-cols-3 max-[650px]:grid-cols-2
        max-[650px]:gap-x-10 max-[650px]:gap-y-4 max-[650px]:items-start"
        >
