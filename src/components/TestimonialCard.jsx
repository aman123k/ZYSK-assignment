...
function TestimonialCard() {
  return (
    <div className="bg-[#F9FAFB] text-center py-16 px-4 max-[650px]:py-8 dark:bg-[#333333]">
      <img src={companyLogo} alt="Logo" className="h-8 mx-auto mb-8" />
      <h2 className="text-3xl font-semibold mb-6 text-[#101828] max-w-2xl mx-auto max-[650px]:text-[30px] dark:text-white">
